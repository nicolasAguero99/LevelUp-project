...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-06-2023 a las 10:28:22
...
--
ALTER TABLE `juegos_x_desarrollador`
  ADD CONSTRAINT `juegos_x_desarrollador_ibfk_2` FOREIGN KEY (`desarrollador_id`) REFERENCES `desarrolladores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
